...
- **Birthday Registry**: Automatic identification of student birthdays on the daily dashboard.
- **Registry Auto-Fill**: Streamlined enrollment by pulling data from the existing school census.
- **PHV Maturity Profiling**: Accurate biological age estimation for injury prevention.
- **Next.js 15 Hardened**: Zero-error build configuration with optimized Firebase memoization.

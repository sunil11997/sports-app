...
const STANDARD_STRATEGIES: Record<string, any[]> = {
  ...
  'Volleyball': [
    ...
    { title: 'क्लिक सेट अटॅक', type: 'Offense', intensity: 'High', desc: 'सेटरने वेगात दिलेल्या बॉलवर लगेच स्पाईक करण्याची पद्धत.', howTo: '१. सेटर आणि अटॅकरमध्ये ताळमेळ महत्त्वाचा आहे.\n२. सेटर बॉलला फक्त १-२ फूट वर उचलतो and अटॅकर वेगात त्याला मारतो.', img: 'https://picsum.photos/seed/v5/600/400' },
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
           <div className="flex items-center gap-6">
             ...
             <div className="space-y-2">
               ...
               <p className="text-xs font-bold text-white/70 uppercase tracking-[0.3em]">Elite Tactical Playbook v4.3.22</p>
             </div>
           </div>

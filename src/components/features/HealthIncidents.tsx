        ...
        <div className="space-y-4">
          {store.data.healthIncidents.length === 0 ? (
            ...
            store.data.healthIncidents.map((inc: any) => (
              <Card key={inc.id} className="border-2 border-primary/10 hover:border-primary/20 transition-all rounded-2xl shadow-sm">
                <CardContent className="p-5">
                  ...
                  <p className="text-sm text-foreground/80 pl-13 mt-2 border-l-2 border-accent ml-5 pl-4 py-1">
                    {inc.description}
                  </p>
                </CardContent>
              </Card>

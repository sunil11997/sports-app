                   ...
                   <div className="grid grid-cols-1 md:grid-cols-12 gap-10">
                      ...
                      <div className="md:col-span-8 space-y-10">
                         <div className="space-y-6">
                            ...
                            <div className="space-y-1.5"><Label className="text-[10px] font-black uppercase opacity-60">Physical Address</Label><Input value={editingPlayer.address} onChange={(e: React.ChangeEvent<HTMLInputElement>) => setEditingPlayer({...editingPlayer, address: e.target.value})} className="h-12 border-2 rounded-xl" /></div>
                         </div>

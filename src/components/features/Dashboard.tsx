        ...
        <DialogContent className="sm:max-w-[500px] rounded-3xl">
          ...
          {editingPlayer && (
            <div className="grid gap-4 py-4">
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="edit-sport" className="text-right font-bold">Sport</Label>
                <div className="col-span-3">
                  <Select 
                    value={editingPlayer.sport} 
                    onValueChange={(val) => setEditingPlayer({ ...editingPlayer, sport: val })}
                  >
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="edit-height" className="text-right font-bold">Height (cm)</Label>
                <Input
                  id="edit-height"
                  type="number"
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="edit-weight" className="text-right font-bold">Weight (kg)</Label>
                <Input
                  id="edit-weight"
                  type="number"
